...
const blogPosts = {
    ...
    'changed-habits-post': {
        ...
        content: `
            ...
            <p>It feels really different now. Kung tutuusin, hindi ko rin alam kung gaano ako nagbago. Siguro pati ang anino ko, iba na rin ang anyo kaysa dati. Maybe that's what growing up is: slowly becoming someone different without realizing exactly when the change happened. I used to think that change had to be something obvious, something that happened all at once. Pero habang tumatagal, napapansin ko na mas madalas pala itong nangyayari sa maliliit na bagay: sa mga lugar na pinipili kong puntahan, sa mga taong gusto kong makasama, at sa mga sandaling natutunan kong pahalagahan. Hindi naman ibig sabihin na lumalayo ako sa mga kaibigan ko. I still enjoy their company, our conversations, and the laughter we share. Mas natutunan ko lang na kailangan ko rin ng oras para sa sarili ko, para makapag-isip at makapagpahinga nang hindi kailangang ipaliwanag ang katahimikan ko.</p>
