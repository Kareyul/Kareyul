...
const blogPosts = {
    ...
    'changed-habits-post': {
        ...
        content: `
            ...
            <p>It feels really different now. I prefer hanging out without liquor now, finding quieter places and slower moments instead. I enjoy sitting in a coffee shop with a drink, a book, or my laptop, letting the afternoon pass without needing to fill every moment with conversation. There is something comforting about being alone in a public place, surrounded by people but free to move at my own pace. But this does not mean that I do not enjoy hanging out with my friends. I still enjoy their company, the conversations we share, and the laughter that comes from spending time together; I simply appreciate having quiet time for myself too. Kung tutuusin, hindi ko rin alam kung gaano ako nagbago. Siguro pati ang anino ko, iba na rin ang anyo kaysa dati. (Funny story, informally.) One night, I was solving a Sturm-Liouville theory problem but couldn't find the solution. Having lost hope, I decided to sleep. Pero guess what? Nagising ako ng 3 AM kasi napanaginipan ko yung problem, at lumilipad yung mga equations hahaha. Dati, I thought being alone meant missing out, but now it feels more like a choice to protect my peace and make space for the things I care about. I am learning that changing does not always mean leaving my old self behind; sometimes, it means finally understanding what kind of life feels honest to me.</p>
