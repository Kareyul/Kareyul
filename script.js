...
const blogPosts = {
    ...
    'changed-habits-post': {
        ...
        content: `
            ...
            <p>Mas gusto ko na ngayon ang mga simpleng bagay, tulad ng pagpunta sa coffee shops, pag-inom ng paborito kong drink, at paglalaan ng oras para sa sarili ko. Hindi ko na kailangang laging may pinupuntahan o kasama para masabing naging maayos ang araw ko. Minsan, sapat na ang tahimik na lugar at kaunting oras para makapag-isip.</p>
            <p>Hindi ibig sabihin nito na ayaw ko nang makasama ang mga kaibigan ko. I still enjoy their company, our conversations, and the laughter we share. Nagbago lang ang paraan kung paano ko gustong gugulin ang oras ko, at natutunan kong okay lang pala na piliin ang tahimik na mga sandali paminsan-minsan.</p>
